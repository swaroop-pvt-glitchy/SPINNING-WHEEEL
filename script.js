...
function getRandomCombination() {
    ...
    do {
        ...
        newCombination = {
            action: randomAction,
            where: randomWhere,
            key: `${randomAction}|||${randomWhere}`
        };
        attempts++;
    } while (spinHistory.includes(newCombination.key) && attempts < maxAttempts);

    return {
        action: newCombination.action,
        where: newCombination.where,
        combination: newCombination.key
    };
}
